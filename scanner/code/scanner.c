...
Token* readIdentKeyword(void) {
  ...
  if (count > MAX_IDENT_LEN)
  {
    error(ERR_IDENTTOOLONG, token->lineNo, token->colNo); // bao loi nhung khong dung chuong trinh
    return token;
  }
  ...
  // neu khong phai keyword thi la dinh danh
